...
def parse_args():
    ...
    parser.add_argument('--gt-anno',
                        ...
                        type=str,
                        default='/Users/lichuxi/Desktop/LCX/STUDY/CODE/DATA/coco/annotations/person_keypoints_val2017.json'
                        )
...
args = parse_args()
prediction = '/Users/lichuxi/Desktop/LCX/STUDY/CODE/deep-high-resolution-net.pytorch-master/output/coco/pose_hrnet/w32_256x192_adam_lr1e-3/results/keypoints_val2017_results_0.json'
args.savepath = 'visualization/results'
...
img_path = '/Users/lichuxi/Desktop/LCX/STUDY/CODE/DATA/coco/images/val2017/'
