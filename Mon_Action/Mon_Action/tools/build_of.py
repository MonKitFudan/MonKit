...
if __name__ == '__main__':
    ...
    parser.add_argument("--df_path", type=str, default='/home1/xiaozf/pycharmpro/tsn/3rd-party/dense_flow/', help='path to the dense_flow toolbox')
    parser.add_argument("--out_format", type=str, default='dir', choices=['dir','zip'],
                        help='path to the dense_flow toolbox')
    parser.add_argument("--ext", type=str, default='avi', choices=['avi','mp4','mpg'], help='video file extensions')
    ...
    parser.add_argument("--num_gpu", type=int, default=3, help='number of GPU')
